...
import edu.ifes.ci.si.les.ats.services.OrcamentoService;
...
public class OrcamentoController {
	...
	public ResponseEntity<Orcamento> insert(@Valid @RequestBody Orcamento obj, BindingResult br) {
		if (br.hasErrors())
	...
	public ResponseEntity<Orcamento> update(@Valid @RequestBody Orcamento obj, BindingResult br) {
		if (br.hasErrors())
			throw new ConstraintException(br.getAllErrors().get(0).getDefaultMessage());
